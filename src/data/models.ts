...
export const models: ModelEntry[] = [
  {
    ...
    version: "v2.2",
    summary:
      "Kompakte DynoGrip-Griffvariante mit STL fuer Direktdruck und STEP fuer Anpassungen im CAD.",
    tags: ["STL Preview", "STEP included", "Compact", "Grip"],
    materials: ["PETG", "PA12", "Tough PLA"],
    printNotes: [
      "0.2 mm Layerhoehe funktioniert gut fuer einen sauberen ersten Prototyp.",
      "Mindestens 4 Perimeter empfohlen, damit die Griffkante robust bleibt.",
      "Bei hoher Belastung PETG oder Nylon statt sprödem PLA bevorzugen.",
    ],
    infoNotes: [
      "Geeignet als Ausgangsbasis fuer kuerzere oder leichtere Griffvarianten.",
  ...
  },
  {
    ...
    version: "v2.2",
    summary:
      "Leichtere Cutout-Version fuer Varianten mit reduziertem Materialeinsatz und besserer Anpassbarkeit.",
    tags: ["Lightweight", "Cutout", "STL Preview", "STEP included"],
    materials: ["PETG", "PA12", "ASA"],
    printNotes: [
      "Support nur aktivieren, wenn im Slicer haengende Innenbereiche problematisch werden.",
      "Mit 25 bis 35 Prozent Gyroid-Infill entsteht ein guter Mix aus Gewicht und Stabilitaet.",
      "Fuer Aussenteile im Warmen ist ASA eine gute Option.",
    ],
    infoNotes: [
      "Die offene Geometrie ist praktisch fuer schnellere Druckzeiten.",
      "Gut geeignet fuer weitere Leichtbau-Iterationen direkt im STEP.",
    ],
    files: [
      {
        label: "Download STL",
  ...
  },
  {
    ...
    version: "v1",
    summary:
      "STEP-Assembly als Basis fuer Anpassungen an Gesamtform, Befestigung und Integration in eigene Setups.",
    ...
    printNotes: [
      ...
      "Fuer Druck bitte zuerst benoetigte Einzelteile oder abgeleitete STL-Dateien exportieren.",
    ],
    infoNotes: [
      "Diese Datei ist primär fuer Konstruktion und Weiterentwicklung gedacht.",
      "Ideal fuer eigene Halterungen, Integration oder Studien am Gesamtsystem.",
    ],
    files: [
      {
        label: "Download STEP",
  ...
  },
  {
    ...
    version: "v1",
    summary:
      "Prototypisches Gehaeuse-Set fuer schnelle Tests mit Hauptkoerper und Deckel als STL.",
    tags: ["Prototype", "STL Preview", "Two parts"],
    materials: ["PETG", "ABS", "Tough PLA"],
    printNotes: [
      "Hauptteil und Deckel sollten mit 4 bis 5 Perimetern gedruckt werden.",
      "PETG ist fuer Prototypen ein guter Standard wegen Schlagzaehigkeit und einfacher Verarbeitung.",
      "Bei passungsrelevanten Bereichen zuerst einen verkleinerten Testdruck fahren.",
    ],
    infoNotes: [
      "Das Set enthaelt Hauptgehaeuse und Deckel als getrennte STL-Dateien.",
      "Gut fuer schnelle Funktionsmuster vor finalen CAD-Aenderungen.",
    ],
    files: [
      {
  ...
  },
  {
    ...
    version: "v2.1",
    summary:
      "Hauptgriff fuer das DynoGrip-System mit direkter STL-Vorschau fuer Formkontrolle vor dem Druck.",
    tags: ["STL Preview", "Primary grip", "Printable"],
    materials: ["PETG", "PA12", "Tough PLA"],
    printNotes: [
      "Bei funktionalen Griffflaechen eher feinere Layerhoehen verwenden.",
      "Fuer hohe Lasten die Ausrichtung so waehlen, dass kritische Kanten nicht quer zur Layer-Richtung belastet werden.",
    ],
    infoNotes: [
      "Wenn spaeter noch Konstruktionseingriffe geplant sind, empfiehlt sich eine zusaetzliche STEP-Ableitung im CAD.",
    ],
    files: [
      {
        label: "Download STL",
  ...
  },
  {
    ...
    version: "v1",
    summary:
      "Deckel-Komponente als STEP-Datei fuer Passungsanpassungen, Ausschnitte und Montagevarianten.",
    tags: ["STEP only", "Cover", "CAD editable"],
    materials: ["CAD reference"],
    printNotes: [
      "Vor dem Export in STL zuerst Toleranzen und Schraubpunkte im CAD pruefen.",
    ],
    infoNotes: [
      "Sinnvoll fuer alle, die Gehaeuseaenderungen direkt im CAD vornehmen wollen.",
    ],
    files: [
      {
        label: "Download STEP",
  ...
  },
  {
    ...
    version: "v1",
    summary:
      "Zusaetzliches Attachment fuer Experimente und Erweiterungen rund um das DynoForce-System.",
    tags: ["Attachment", "STL Preview", "Accessory"],
    materials: ["PETG", "Nylon"],
    printNotes: [
      "Bei Zubehoerteilen mit Krafteinleitung eher zaehe Materialien waehlen.",
      "Kritische Belastungspunkte nach dem Druck visuell auf Layertrennung pruefen.",
    ],
    infoNotes: [
      "Ein guter Kandidat fuer Community-Remixes und Setups ausserhalb des Standardgeraets.",
    ],
    files: [
      {
        label: "Download STL",
